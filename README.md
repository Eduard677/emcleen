...
The entrance lets visitors choose their service, then the full interface transforms between the Auto and Property identities. Direct `/auto`, `/home` and `/review` routes are configured for campaigns and sharing.
...
cp index.html review.html .vercel-static/
